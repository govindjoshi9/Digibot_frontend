    ...
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }}>
      <Stack spacing={3} sx={{ width: 1 }}>
        <Block title="General" sx={style}>
          ...
          <TextField required fullWidth label="Activated" defaultValue="Hello XPic" />
          <TextField fullWidth type="password" label="Password" autoComplete="current-password" />
          <TextField disabled fullWidth label="Disabled" defaultValue="Hello XPic" />
        </Block>
        ...
        <Block title="With Caption" sx={style}>
          <TextField fullWidth label="Error" defaultValue="Hello XPic" helperText="Incorrect entry." />
          <TextField error fullWidth label="Error" defaultValue="Hello XPic" helperText="Incorrect entry." />
        </Block>
      </Stack>
